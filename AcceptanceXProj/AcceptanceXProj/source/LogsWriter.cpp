...
void log_file_init(std::ofstream &out_file) {
    ...
    out_file << "Generation plane (X) (in meters): "<<Ldet<<std::endl;
    out_file << "Generation plane (Y) (in meters): "<<Ldet<<std::endl;
    out_file << "Detector lenght (in meters): "<<Ldet<<std::endl;
    out_file << "Detector depth (in meters): "<<Ldet<<std::endl;
    out_file << "Detector high (in meters): "<<Hdet<<std::endl;
    out_file << "Number of checked layers for geometrical acceptace computing: "<< 2 <<std::endl;
