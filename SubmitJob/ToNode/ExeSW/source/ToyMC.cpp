...
int main(int argc,char *argv[]) {
    ...
    TH2D costheta_phi_acceptance("Acceptance","Theta/Phi Acceptance", 500, 0.5, 1, 500, 0, 2.0*TMath::Pi());
    ...
    TH1D Acceptance_X_Proj("Acceptance_X_Proj"," cos(#theta) distribution ",1000,0.5,1);
    ...
    TH2D costheta_phi_inside("EventsDistribution","Events Angular Distibution", 500, 0.5, 1, 500, 0, 2.0*TMath::Pi());
